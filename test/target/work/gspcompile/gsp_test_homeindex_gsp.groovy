...
class gsp_test_homeindex_gsp extends GroovyPage {
...
printHtmlPart(5)
expressionOut.print(request.contextPath + '/home/jsontree')
printHtmlPart(6)
})
...
public static final long LAST_MODIFIED = 1411309287624L
